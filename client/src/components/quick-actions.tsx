    ...
    <div className="px-4 mb-6">
      ...
      <div className="grid grid-cols-4 gap-3">
        ...
        {hasActiveBake ? (
          ...
          <button 
            onClick={onStartBake}
            className="bg-sourdough-500 hover:bg-sourdough-600 rounded-xl p-4 shadow-sm text-center transition-colors text-white"
          >
            <Plus className="w-6 h-6 mx-auto mb-2" />
            <p className="text-sm font-medium">Start Bake</p>
          </button>
        )}
      </div>
    </div>
